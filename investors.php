...
$query_rsInvestors = "SELECT * FROM ip_investors ORDER BY iName ASC";
...
<p><a href="add_investors.php" class="btn">Add New Investor</a></p>
<table id="tblList" border="0" cellspacing="1" cellpadding="4" summary="investment company list">
<tr class="caption">
<th scope="col">Investment Company Name &nbsp;&nbsp;&nbsp;</th>
<th>&nbsp;</th>
</tr>
<?php do { ?>
  <tr>
    <td class="t1"><?php echo $row_rsInvestors['iName']; ?></td>
    <td class="t2"><a href="edit_investors.php?iid=<?php echo $row_rsInvestors['iID']; ?>">Edit</a> | <a href="delete_investors.php?iid=<?php echo $row_rsInvestors['iID']; ?>">Delete</a>&nbsp;</td>
  </tr>
